...
describe("commands", function()
    ...
    it("setup_session_load_current should add SessionLoadCurrent command", function()
        test_setup_command("SessionLoadCurrent", function()
            require("seshmgr.commands")._setup_session_load_current("/tmp", "!")
        end)
    end)
end)
